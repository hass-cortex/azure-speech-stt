...
class CorrectionConfig:
    ...
    enable_entity_hints: bool = DEFAULT_ENABLE_ENTITY_HINTS
    ...
    @classmethod
    def from_options(cls, options: dict) -> CorrectionConfig:
        ...
        """
        return cls(
            enable_entity_hints=options.get(
            ...
            auto_collect_sources=options.get(
